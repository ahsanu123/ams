pub mod schema {
    ...
    pub mod posts {
        ...
        pub const all_columns: (id, title, body, published) = (
            id,
            title,
            body,
            published,
        ...
        pub mod columns {
            ...
            impl<QS> diesel::AppearsOnTable<QS> for title
            where
                QS: diesel::query_source::AppearsInFromClause<
                    super::table,
                    Count = diesel::query_source::Once,
            ...
            impl<QS> diesel::AppearsOnTable<QS> for body
            where
                QS: diesel::query_source::AppearsInFromClause<
                    super::table,
                    Count = diesel::query_source::Once,
            ...
            impl<QS> diesel::AppearsOnTable<QS> for published
            where
                QS: diesel::query_source::AppearsInFromClause<
                    super::table,
                    Count = diesel::query_source::Once,
