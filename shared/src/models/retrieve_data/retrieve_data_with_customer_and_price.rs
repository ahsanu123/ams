use crate::models::{customer::Customer, price::Price, to_active_model_trait::ToActiveModel};
...
impl RetrieveDataWithCustomerAndPrice {
...
impl ToActiveModel<ams_entity::retrieve_data::ActiveModel> for RetrieveDataWithCustomerAndPrice {
